 ...
 * still short at 6:00pm. Now includes the recommended court arrangements
 * from Procedure 2 when available.
 *
 * REPLACES the existing sendCourtAssignmentReview in lib/email.js.
 *
 * @param {object} params
 ...
 * @param {string}   params.deadlineLabel
 * @param {string[]} params.tentativePlayerNames
 * @param {string[]} [params.courtSummaryLines]  — one line per court from P2,
 *   e.g. ["Court A · Memorial Park: Alice B, Bob C (skill 5–6)",
 *          "Court B · Memorial Park: Dave E, Eve F (skill 4–5)",
 *          "Tentative (incomplete court): Frank G"]
 * @returns {Promise<boolean>}
 */
